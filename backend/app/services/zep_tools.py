...
logger = get_logger('predly.zep_tools')
...
class ZepToolsService:
    ...
    4. interview_agents - Deep interview (interviews simulated Agents, gets multi-perspective insights)
    ...
    def get_node_edges(self, graph_id: str, node_uuid: str) -> List[EdgeInfo]:
        ...
        try:
            ...
            result = []
            for edge in all_edges:
                # Check if edge is connected to the specified node (as source or target)
    ...
    def get_graph_statistics(self, graph_id: str) -> Dict[str, Any]:
        ...
        # Statistics on relationship type distribution
        relation_types = {}
        for edge in edges:
    ...
    def insight_forge(
        ...
        The most powerful hybrid retrieval function, automatically decomposes questions
        ...
        # Fetch details of all related entities (no limit, full output)
        entity_insights = []
        ...
        for uuid in list(entity_uuids):  # Process all entities, no truncation
            if not uuid:
                continue
            try:
                # Fetch each related node's information individually
...
Requirements:
1. Each sub-question should be specific enough to find relevant Agent behavior or events in the simulated world
...
{f"Report context: {report_context[:300]}" if report_context else ""}
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        3. Classifies current active and historical information
        
        This tool is suitable for scenarios that require understanding the full picture of events
        or tracing the evolution process.
    ...
    def interview_agents(
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "and answer the following questions in plain text directly.\n"
            "Reply requirements:\n"
        ...
        try:
            ...
            api_result = SimulationRunner.interview_agents_batch(
                ...
                timeout=300.0    # Both platforms need longer timeout
            )
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Always output dual-platform label
    ...
    def _load_agent_profiles(self, simulation_id: str) -> List[Dict[str, Any]]:
        ...
        # Prioritize reading Reddit JSON format
...
Return in JSON format:
{
    ...
    "reasoning": "Explanation of selection reasoning"
        ...
        {simulation_requirement[:300] if simulation_requirement else "Not provided"}

        Available Agent list (total {len(agent_summaries)}, showing first {len(display_agents)}):
...
2. Questions that may have different answers depending on the interviewee's role
