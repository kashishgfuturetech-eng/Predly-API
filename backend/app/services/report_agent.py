...
logger = get_logger('predly.report_agent')
...
class ReportLogger:
    ...
    def log_planning_context(self, context: Dict[str, Any]):
        ...
        self.log(
            ...
            stage="planning",
            details={
                "message": "Get simulation content information",
                "context": context
            }
        )
    ...
    def log_section_start(self, section_title: str, section_index: int):
        ...
        self.log(
            ...
            section_title=section_title,
            section_index=section_index,
            details={"message": f"Start generating chapter: {section_title}"}
        )
    ...
    def log_react_thought(self, section_title: str, section_index: int, iteration: int, thought: str):
        ...
        self.log(
            ...
            details={
                "iteration": iteration,
                "thought": thought,
                "message": f"ReACT {iteration} round of thinking"
            }
        )
    ...
    def log_tool_result(
        ...
        self.log(
            ...
            details={
                ...
                "message": f"Tool {tool_name} returns the result"
            }
        )
    ...
    def log_section_content(
        ...
        self.log(
            ...
            details={
                ...
                "message": f"chapter {section_title} content generated complete"
            }
        )
    ...
    def log_section_full_complete(
        ...
        self.log(
            ...
            details={
                ...
                "message": f" chapter generated {section_title} successfully"
            }
        )
    ...
    def log_error(self, error_message: str, stage: str, section_title: str = None):
        ...
        self.log(
            ...
            details={
                "error": error_message,
                "message": f"An error occured: {error_message}"
            }
        )
...
class ReportAgent:
    ...
    def __init__(
        ...
        logger.info(f"ReportAgent imnitialization complete: graph_id={graph_id}, simulation_id={simulation_id}")
    ...
    def _define_tools(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            "insight_forge": {
                ...
                "parameters": {
                    "query": "The question or topic u want to analyse in depth",
                    "report_context": "the context of current report section (optional, helps generate more precise sub-sections)"
                }
            },
            "panorama_search": {
                ...
                "parameters": {
                    "query": "search query, used for relevant ranking",
                    "include_expired": "whether to include expired/historical (default True)"
                }
            },
            "quick_search": {
                "name": "quick_search",
            ...
            "interview_agents": {
                ...
                "parameters": {
                    "interview_topic": "interview topic or needs description e.g.: 'understanding students views in formaldehyde incident in dormitory'",
                    "max_agents": "maximum number of Agent to interview (optional, default 5, maximum 10)"
                }
            }
        }
    ...
    def _execute_tool(self, tool_name: str, parameters: Dict[str, Any], report_context: str = "") -> str:
        ...
        try:
            ...
            # ========== Legacy tools for backwards compatibility (internally redirected to new tools) ==========
                ...
                logger.info("search_graph has been rediracted quick_search")
                ...
                logger.info("get_simulation_context has been redirected insight_forge")
            ...
            logger.error(f"tool executuon failed: {tool_name}, error: {str(e)}")
            return f"the tool failed to execute: {str(e)}"
    ...
    def _parse_tool_calls(self, response: str) -> List[Dict[str, Any]]:
        ...
        # Only attempted when Format 1 does not match, to avoid false matches in response body
    ...
    def plan_outline(
        ...
        if progress_callback:
            progress_callback("planning", 0, "analysing simulation requiremnets...")
        ...
        if progress_callback:
            progress_callback("planning", 30, "generating report ooutline...")
        ...
        try:
            ...
            logger.error(f"Future Prediction report: {str(e)}")
            # Return default outline (3 sections, as fallback)
            return ReportOutline(
                title="Future Prediction report",
                summary="Analysis of future trends and risks based on simulation prediction",
                sections=[
                    ReportSection(title="Predicted scenarios and core discoveries"),
                    ReportSection(title="Crowd behavviour pprediction analysis"),
    ...
    def _generate_section_react(
        ...
        """
        Generate a single section content using the ReACT pattern
        ...
        # Build user prompt - each completed section is limited to 4000 characters
        ...
        for iteration in range(max_iterations):
            if progress_callback:
                progress_callback(
                    ...
                    f"Deep search and writing ({tool_calls_count}/{self.MAX_TOOL_CALLS_PER_SECTION})"
                )
            ...
            if response is None:
                ...
                if iteration < max_iterations - 1:
                    messages.append({"role": "assistant", "content": "(the response is empty)"})
                    messages.append({"role": "user", "content": "please continue generating content"})
                    continue
                # Last iteration also returned None, exit loop for forced finalization
                break
            ...
            if has_tool_calls and has_final_answer:
                ...
                logger.warning(
                    ...
                    f"LLM simultaneously output tool calls and the Final Answer (conflict count {conflict_retries})"
                )
            ...
            if has_tool_calls:
                # Tool quota exhausted → notify clearly, ask for Final Answer output
            ...
            # Directly use this content as the final answer, no further iteration
    ...
    def generate_report(
        ...
        """
        Generate full report (real-time section-by-section output)

        Each section is saved immediately after generation, without waiting for the full report to complete.
        File structure:
        reports/{report_id}/
...
class ReportManager:
    ...
    def get_console_log(cls, report_id: str, from_line: int = 0) -> Dict[str, Any]:
        ...
        Args:
            report_id: Report ID
            from_line: Line number to start reading from (0 = from the beginning, for incremental retrieval)
    ...
    def get_console_log_stream(cls, report_id: str) -> List[str]:
        """
        Get the full console log (retrieve all at once)
    ...
    def get_agent_log_stream(cls, report_id: str) -> List[Dict[str, Any]]:
        """
        Get the full Agent log (retrieve all at once)
    ...
    def _clean_section_content(cls, content: str, section_title: str) -> str:
        ...
        for i, line in enumerate(lines):
            ...
            # If the previous line was a skipped title and current line is empty, skip it too
    ...
    def _post_process_report(cls, content: str, outline: ReportOutline) -> str:
        ...
        while i < len(lines):
            ...
            if heading_match:
                ...
                # Check if it is a duplicate heading (same heading appearing within 5 consecutive lines)
                is_duplicate = False
                ...
                if level == 1:
                    ...
                    # Convert ### and below level headings to bold text
                    processed_lines.append(f"**{title}**")
                    processed_lines.append("")
                    prev_was_heading = False
                ...
                # Skip separator line immediately after a heading
                i += 1
                continue
    ...
    def get_report(cls, report_id: str) -> Optional[Report]:
        ...
        if not os.path.exists(path):
            # Old format compatibility: check files stored directly in reports directory
        ...
        for item in os.listdir(cls.REPORTS_DIR):
            ...
            if os.path.isdir(item_path):
                ...
                if report and report.simulation_id == simulation_id:
                    return report
            # Old format compatibility: JSON file
    ...
    def delete_report(cls, report_id: str) -> bool:
        ...
        # Old format compatibility: delete individual files
        deleted = False
