...
2. Simulation scripts poll the commands directory, execute commands, and write responses to responses/
...
logger = get_logger('predly.simulation_ipc')
...
class SimulationIPCClient:
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: target platform (optional)
                ...
                - None: interview both platforms in dual-platform simulations, or the active platform in single-platform ones
            timeout: timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: default platform (optional; overridden per-interview by each item's platform field)
                - "twitter": default to Twitter platform only
                - "reddit": default to Reddit platform only
                - None: interview both platforms simultaneously per agent in dual-platform simulations
            timeout: timeout in seconds
