...
logger = get_logger('predly.zep_graph_memory_updater')
...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        """
        Convert activity into text description to send to Zep
        ...
        # Return in "agent_name: activity description" format directly, without simulation prefix
    ...
    def _describe_create_comment(self) -> str:
        """Create comment - includes comment content and info about the post being commented on"""
        content = self.action_args.get("content", "")
        post_content = self.action_args.get("post_content", "")
        post_author = self.action_args.get("post_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    All meaningful actions are updated to Zep, and action_args will contain full
    context information:
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Activity buffers grouped by platform (each platform accumulates to BATCH_SIZE before sending)
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args will contain full context information (e.g. post content, usernames, etc.)
    ...
    def add_activity_from_dict(self, data: Dict[str, Any], platform: str):
        """
        Add activity from a dictionary
    ...
    def _flush_remaining(self):
        ...
        # First, process remaining activities in the queue and add them to buffers
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "items_sent": self._total_items_sent,        # Number of activity items successfully sent
