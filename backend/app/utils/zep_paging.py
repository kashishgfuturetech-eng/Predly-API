...
transparently returning a complete list to the caller.
"""
...
logger = get_logger('predly.zep_paging')
...
def fetch_all_edges(
    ...
    """Fetch all graph edges with pagination, returning a complete list. Each page request includes retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
