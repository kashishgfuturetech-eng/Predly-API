# Predly Frontend - Chinese Text Translation Inventory

## Overview
Complete inventory of Chinese text found in the Predly frontend application that requires translation to English.
...
- `<meta name="description" content="Predly - 社交媒体舆论模拟系统" />` (Predly - Social Media Opinion Simulation System)
- `<title>Predly - 预测万物</title>` (Predly - Predict Everything)
